...
- [Docker環境](dev/DOCKER.md) - コンテナ構成と起動方法
- [Linter設定](dev/LINTER.md) - 静的解析ツールの設定

## 🤖 AI協働向け
- [AI協働ガイド](ai/README.md) - AI活用の全体像と使い方
- [システムプロンプト](ai/prompts/system/) - AIの基本動作定義（作成予定）
...
## 📝 テスト
- [テストリスト](testlists/README.md) - テストケース管理方針
- [E2Eテスト](../e2e/README.md) - Playwright + Cucumber
