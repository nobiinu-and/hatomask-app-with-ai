...
- [ ] Phase 4 で実装計画が作成されている
- [ ] Phase 5 で Backend Stub が作成されている
...
Phase 6 開始前に、以下のドキュメントを作成してください。
...
- **AI 協働プロトコル**: `docs/dev/DEVELOPMENT.md#ai協働プロトコル`
