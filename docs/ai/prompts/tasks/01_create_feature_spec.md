---
description: 対話的ヒアリングを通じて機能仕様書と受け入れ基準を作成するためのプロンプトテンプレート
---
...
1. **段階的に質問する**: すべてを一度に聞かず、セクション単位で進める
...
- **ユースケース**: 基本フロー、代替フロー
- **機能要件**: 詳細な要件（入力、処理、出力）
- **UI/UX 要件**: レイアウト、デザイン、インタラクション
- **受け入れ基準**: Gherkin 形式のシナリオ（5 つ以上）
...
- **テンプレート**: `docs/spec/templates/feature-spec.template.md`
- **品質基準**: `docs/dev/standards/quality.md`
