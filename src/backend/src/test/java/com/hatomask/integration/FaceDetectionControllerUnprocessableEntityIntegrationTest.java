...
@DisplayName("FaceDetectionController 統合テスト（422）")
@Disabled("Duplicate of FaceDetectionControllerNoFaceIntegrationTest")
class FaceDetectionControllerUnprocessableEntityIntegrationTest {
