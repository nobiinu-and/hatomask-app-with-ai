...
|----|-------------|---------|---------------|
| 1 | 正常系：JPEG完全なフロー | 1. アプリにアクセス<br>2. 「写真を選択」ボタンをクリック<br>3. JPEGファイル（5MB）を選択<br>4. プレビュー確認<br>5. 「ダウンロード」ボタンをクリック | 1. ページが正常に表示される<br>2. ファイル選択ダイアログが開く<br>3. アップロードが成功し、画面が更新される<br>4. プレビューエリアに画像が表示される<br>5. 元の画像がダウンロードされる |
| 2 | 正常系：PNG完全なフロー | 1. アプリにアクセス<br>2. 「写真を選択」ボタンをクリック<br>3. PNGファイル（3MB）を選択<br>4. プレビュー確認<br>5. 「ダウンロード」ボタンをクリック | 1. ページが正常に表示される<br>2. ファイル選択ダイアログが開く<br>3. アップロードが成功し、画面が更新される<br>4. プレビューエリアに画像が表示される<br>5. 元の画像がダウンロードされる |
| 3 | 正常系：複数回のアップロード | 1. 1枚目のJPEGファイルをアップロード<br>2. プレビュー確認<br>3. 「写真を選択」ボタンをクリック<br>4. 2枚目のPNGファイルを選択<br>5. プレビュー確認 | 1. 1枚目の画像がプレビューに表示<br>2. 1枚目のプレビューが表示されている<br>3. ファイル選択ダイアログが開く<br>4. アップロード成功<br>5. 2枚目の画像にプレビューが切り替わる |
| 4 | 異常系：ファイルサイズ超過 | 1. アプリにアクセス<br>2. 11MBのJPEGファイルを選択 | エラーメッセージ「ファイルサイズは10MB以下にしてください」が表示される |
| 5 | 異常系：非対応のファイル形式 | 1. アプリにアクセス<br>2. GIFファイルを選択 | エラーメッセージ「JPEG または PNG ファイルを選択してください」が表示される |
| 6 | UI状態：初期状態 | 1. アプリにアクセス | 「写真を選択」ボタンが表示され、「ダウンロード」ボタンが無効化されている |
| 7 | UI状態：アップロード後 | 1. 写真をアップロード | プレビューが表示され、「ダウンロード」ボタンが有効化されている |
...
| ブラウザ | バージョン | 確認項目 |
|---------|-----------|---------|
| Chrome | 最新版 | ファイル選択、アップロード、プレビュー、ダウンロードが正常に動作する |
| Firefox | 最新版 | ファイル選択、アップロード、プレビュー、ダウンロードが正常に動作する |
| Safari | 最新版 | ファイル選択、アップロード、プレビュー、ダウンロードが正常に動作する |
| Edge | 最新版 | ファイル選択、アップロード、プレビュー、ダウンロードが正常に動作する |

### レスポンシブテスト

| デバイス/画面サイズ | 確認項目 |
|-------------------|---------|
| デスクトップ（1920x1080） | レイアウトが正常に表示され、すべての機能が動作する |
| タブレット（768x1024） | レイアウトが適切に調整され、すべての機能が動作する |
| モバイル（375x667） | レイアウトが適切に調整され、すべての機能が動作する |
